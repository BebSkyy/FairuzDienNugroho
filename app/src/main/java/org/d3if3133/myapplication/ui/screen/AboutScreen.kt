...
import org.d3if3133.myapplication.database.CatatanDb
import org.d3if3133.myapplication.ui.theme.MyApplicationTheme
import org.d3if3133.myapplication.util.ViewModelFactory
...
@Composable
fun AboutScreen(navController: NavHostController, id: Long? = null){
    val context = LocalContext.current
    val db = CatatanDb.getInstance(context)
    val factory = ViewModelFactory(db.dao)
    val viewModel: AboutViewModel = viewModel(factory = factory)
            ...
            TopAppBar(
                ...
                actions = {
                    ...
                    if (id != null) {
                        ...
                        DisplayAlertDialog(openDialog = showDialog,
